...
AbilityType = {
    ...
    2: "профессиональный гоп-стоп",
    3: "биологическая диверсия",
    4: "магнит для подарков",
    5: "перепись судьбы",
    6: "гендерная инверсия",
    7: "политический вес (2 голоса)",
    8: "социальный обмен",
    9: "депортация в бункер",
    10: "абсолютная бездарность"
}

SkillType = {
    0: "рукожоп-энтузиаст",
    1: "самоучка с YouTube",
    2: "уверенный середняк",
    3: "мастер своего дела",
    4: "живая легенда",
    5: "бог этой профессии"
}

rase = {
    0: "человек", 1: "дворф", 2: "гном", 3: "орк", 4: "эльф",
    5: "кошкодевочка/кошкопарень", 6: "кроликочеловек", 7: "ящеролюд",
    8: "вампир", 9: "оборотень", 10: "зомби", 11: "робот",
    12: "инопланетянин", 13: "ошибка природы"
}
...
appearance = {
    0: "серая масса",
    1: "модельный сорт",
    2: "лицо, которое трудно забыть (к сожалению)",
    3: "галлюциногенный вид",
    4: "ходячий анекдот",
    5: "запретное искушение"
}

heal = {
    0: "одна нога в могиле",
    1: "букет хронических радостей",
    2: "постоянный зуд в душе и теле",
    3: "хрупкое создание",
    4: "легкий недомогатор",
    5: "стерильный атлант"
}

heal_appearance = {
    0: "всё лицо — сплошной симптом",
    1: "скрыто слоями одежды и стыда",
    2: "видно только под рентгеном",
    3: "выглядит здоровым (это обман)"
}
